...
SUBJECT_KEYWORDS: dict[str, list[str]] = {
    ...
    "manufacturing_facility": [
        ...
        "compressed air manufacturing", "motor systems",
        "pulp paper manufacturing", "cement manufacturing",
        "steel manufacturing", "chemical process plant",
    ],
    "datacenter": [
    ...
    "warehouse_distribution": [
        ...
        "logistics facility lighting",
    ],
    "infrastructure_node": [
        "electrical substation transformer", "transmission grid",
        "natural gas pipeline", "rail freight operations",
    ],
}
